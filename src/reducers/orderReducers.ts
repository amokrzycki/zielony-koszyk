...
export const orderReducers = {
  ...
  setShippingAddress(state: OrderState, action: PayloadAction<CreateAddress | Address>) {
    state.orderInfo.shippingAddress = action.payload;
  },
  setBillingAddress(state: OrderState, action: PayloadAction<CreateAddress | Address>) {
